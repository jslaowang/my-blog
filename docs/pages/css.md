# CSS 核心进阶
[思维导图链接（高清可缩放）](https://www.processon.com/view/link/61e668441e085306c9778658)

图中1, 2, 3, 4 表示优先级
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/css-xmind.55yadst8s3k0.webp)
...
- 文本系列属性
  ...
  - color：文本颜色
- 元素可见性 如 visibility：控制元素显示隐藏
- 列表布局属性
  - list-style：列表风格，包括 list-style-type、list-style-image 等
- 光标属性 如 cursor：光标显示为何种形态
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/stardand-box.6za76pypgjc0.webp)
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/ie-box.12j6dh39azf4.webp)
...
## 17. 什么是物理像素，逻辑像素和像素密度，为什么在移动端开发时需要用到@3x, @2x 这种图片？
...
::: tip 提示
由于上面的三个属性都是 CSS3 的属性，不是所有浏览器都可以兼容，所以要在前面加一个-webkit- 来兼容一部分浏览器。
:::
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/notcss-to-css.3ahkpl4z07g0.webp)
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/css-to-old.4546b2yl5mg0.webp)
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/view-area.312d7dmbsug0.webp)
...
`<transform-function>`CSS数据类型用于对元素的显示做变换。通常，这种变换可以由矩阵表示，并且可以使用每个点上的矩阵乘法来确定所得到的图像。下面简单展示下`<transform-function>`值都有哪些
...
这其中的道理可以看[这篇文章](https://blog.csdn.net/wuguidian1114/article/details/105559117)了解一下（具体就是与auto的定义有关）
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/stack-order.6y9o3ni0yz40.webp)
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/three1.4rb0hqfqha80.webp)
...
```
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/three2.kqrm9kyzkx8.webp)
...
```
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/three3.15ddrz9oaleo.webp)
...
```
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/three4.4jil6b22dus0.webp)
...
```
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/three5.4xya4gbr6240.webp)
...
```
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/three6.4cwspq7swng0.webp)
...
```
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/shan.27p5pskb4j40.webp)
