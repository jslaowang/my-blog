# JS 核心进阶
[思维导图链接（高清可缩放）](https://www.processon.com/view/link/61e7a17b1efad4259c7430bb)

图中1, 2, 3, 4 表示优先级
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/js-xmind.6q0b3f20fdg0.webp)
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/double-number.7cvv00mf4g00.webp)
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/type-change.5y0q4y1m9g00.webp)
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/jiegou1.6a6hw42v4es0.webp)
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/jiegou2.38dk76516os0.webp)
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/jiegou3.1r6msjj60a8w.webp)
...
## 42. Unicode、UTF-8、UTF-16、UTF-32的区别？---了解即可
**（1）Unicode**
...
## 47. escape、encodeURI、encodeURIComponent 的区别
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/prototype1.5738zah897c0.webp)
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/prototype2.5us1nv74cn40.webp)
...
## 69. setTimeout、Promise、Async/Await 的区别
**（1）setTimeout**
```js
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/await1.38jrik576h40.webp)
...
## 73. Promise.all和Promise.race的区别的使用场景
**（1）Promise.all**
...
![img](https://cdn.jsdelivr.net/gh/jslaowang/image-hosting@master/await2.60r3aoosbps0.webp)
...
## 79. 什么是回调函数？回调函数有什么缺点？如何解决回调地狱问题？
以下代码就是一个回调函数的例子：
```js
ajax(url, () => {
    // 处理逻辑
...
## 80. setTimeout、setInterval、requestAnimationFrame 各有什么特点？
