...
## 9. 你对React Router的理解？常用的Router组件有哪些？
...
## 12. Real DOM和 Virtual DOM 的区别？优缺点？
...
## 13. 对Redux中间件的理解？常用的中间件有哪些？实现原理？
...
## 21. 在React项目中是如何使用Redux的? 项目结构是如何划分的？
...
## 22. 对immutable的理解？如何应用在react项目中？
...
## 24. 如何提高组件的渲染效率的？在React中如何避免不必要的render？
...
## 26. React生命周期有哪些不同阶段？每个阶段对应的方法是？
...
## 28. React render方法的原理？在什么时候会被触发？
    ...
    render() {
        return (
            <div>
                ...
                <button onClick={e => this.changeText()}>xxx系列</button>
            </div>
        )
    }
